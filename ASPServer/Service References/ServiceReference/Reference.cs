...
namespace ASPServer.ServiceReference {
    ...
    public interface IService {
        ...
        void InsertAppointment(ASPServer.ServiceReference.Appointment appointment, ASPServer.ServiceReference.Buyer buyer, ASPServer.ServiceReference.Seller seller);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/InsertAppointment", ReplyAction="http://tempuri.org/IService/InsertAppointmentResponse")]
        System.Threading.Tasks.Task InsertAppointmentAsync(ASPServer.ServiceReference.Appointment appointment, ASPServer.ServiceReference.Buyer buyer, ASPServer.ServiceReference.Seller seller);
        ...
        void UpdateAppointment(ASPServer.ServiceReference.Appointment appointment, System.DateTime date, System.DateTime StartTime, System.DateTime EndTime, string category, string descricption, string status);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/UpdateAppointment", ReplyAction="http://tempuri.org/IService/UpdateAppointmentResponse")]
        System.Threading.Tasks.Task UpdateAppointmentAsync(ASPServer.ServiceReference.Appointment appointment, System.DateTime date, System.DateTime StartTime, System.DateTime EndTime, string category, string descricption, string status);
        ...
        ASPServer.ServiceReference.User GetUserById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService/GetUserById", ReplyAction="http://tempuri.org/IService/GetUserByIdResponse")]
        System.Threading.Tasks.Task<ASPServer.ServiceReference.User> GetUserByIdAsync(int id);
    ...
    public partial class ServiceClient : System.ServiceModel.ClientBase<ASPServer.ServiceReference.IService>, ASPServer.ServiceReference.IService {
        ...
        public void InsertAppointment(ASPServer.ServiceReference.Appointment appointment, ASPServer.ServiceReference.Buyer buyer, ASPServer.ServiceReference.Seller seller) {
            base.Channel.InsertAppointment(appointment, buyer, seller);
        }
        
        public System.Threading.Tasks.Task InsertAppointmentAsync(ASPServer.ServiceReference.Appointment appointment, ASPServer.ServiceReference.Buyer buyer, ASPServer.ServiceReference.Seller seller) {
        ...
        public void UpdateAppointment(ASPServer.ServiceReference.Appointment appointment, System.DateTime date, System.DateTime StartTime, System.DateTime EndTime, string category, string descricption, string status) {
            base.Channel.UpdateAppointment(appointment, date, StartTime, EndTime, category, descricption, status);
        }
        
        public System.Threading.Tasks.Task UpdateAppointmentAsync(ASPServer.ServiceReference.Appointment appointment, System.DateTime date, System.DateTime StartTime, System.DateTime EndTime, string category, string descricption, string status) {
        ...
        public ASPServer.ServiceReference.User GetUserById(int id) {
            return base.Channel.GetUserById(id);
        }
        
        public System.Threading.Tasks.Task<ASPServer.ServiceReference.User> GetUserByIdAsync(int id) {
